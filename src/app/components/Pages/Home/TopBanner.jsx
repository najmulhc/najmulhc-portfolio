const TopBannerSection = ({ numberText, text }) => {
  return (
    <div>
      ...
      <h2 className="font-semibold text-[32px] text-[#dedede] leading-[32px]">{text}</h2>
    </div>
  );
};
const TopBanner = () => {
  return (
    <section className="px-[128px] bg-[#764ABC] text-white flex justify-center  gap-[128px] items-center text-center py-[48px]">
